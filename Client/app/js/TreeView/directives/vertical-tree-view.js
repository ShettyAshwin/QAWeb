...
/*
 ...
 '<i class="collapsed" data-ng-show={{node.type == asset && node.nodeChildren.length && node.collapsed}} data-ng-click="' + a + '.selectNodeHead(node)"></i>' +
 '<i class="expanded" data-ng-show={{node.type == asset && node.nodeChildren.length && !node.collapsed}} data-ng-click="' + a + '.selectNodeHead(node)"></i>' +
