...
var hierarchySchema = new baseframework.mongoose.Schema({name: String, address: String, order : Number, locationId : {type: baseframework.mongoose.Schema.Types.ObjectId, ref:'Location'}, assertId : [{type: baseframework.mongoose.Schema.Types.ObjectId, ref:'Asset'}]});
